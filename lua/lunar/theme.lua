...
theme.set_highlights = function()
  ...
  hl(0, "MsgSeparator", { fg = c.fg, bg = c.warning })
  ...
  hl(0, "VertSplit", { fg = c.bg_dark, bg = 'NONE' })
  hl(0, "WinSeparator", { fg = c.bg_dark, bg = 'NONE', bold=true, })
  hl(0, "NormalFloat", { fg = c.fg, bg = 'NONE' })
  hl(0, "FloatBorder", { fg = c.border_highlight, bg = 'NONE' })
  ...
  hl(0, "DiagnosticVirtualTextInfo", { fg = c.blue2, bg = 'NONE' })
  hl(0, "DiagnosticVirtualTextWarn", { fg = c.yellow, bg = 'NONE' })
  hl(0, "DiagnosticVirtualTextError", { fg = c.red1, bg = 'NONE' })
  ...
  hl(0, "TelescopeSelectionCaret", { fg = c.orange , bg = c.bg_visual })
  ...
  hl(0, "NvimTreeNormalNC", { fg = c.fg_dark, bg = 'NONE' })
  hl(0, "NvimTreeVertSplit", { fg = c.bg_dark, bg = 'NONE' })
  hl(0, "NvimTreeWinSeparator", { fg = c.bg_dark, bg = 'NONE' })
